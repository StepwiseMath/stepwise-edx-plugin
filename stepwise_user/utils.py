...
def set_language_preference(request):
    ...
    if preferred_language:
        log.info("user {username} (1) prefers language {preferred_language}".format(
    ...
    if language_param:
        ...
        log.info("stepwise_user.utils.set_language_preference() (2) detected language param={language_param}. closest installed={closest_lang}".format(
            language_param=language_param,
            closest_lang=closest_lang
            ))
    ...
    if referrer_domain and referrer_domain[:2].lower() == 'mx':
        ...
        log.info("stepwise_user.utils.set_language_preference() (3) detected referrer_domain={referrer_domain}. closest installed={closest_lang}".format(
